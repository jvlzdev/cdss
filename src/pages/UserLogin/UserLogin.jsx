...
function UserLogin() {
  ...
  function handleLogin(e) {
    ...
    console.log("login", { licenseNo, password });
    try {
      login({ licenseNo, password });
    } catch (error) {
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <a className=" text-blue-600 flex justify-center" href="#">
            ...
            <form onSubmit={handleLogin} className="mt-8 grid gap-6">
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  id="LicenseNo"
                  name="license_no"
                  className="mt-1 w-full rounded-md border-gray-200 bg-white text-lg text-gray-700 shadow-sm p-2"
                />
              </div>
              <div className="col-span-6 sm:col-span-3">
                <label
              ...
              {
                isError && <div className="col-span-6 sm:col-span-6 text-red-500 text-sm">{error?.data}</div>
              }
              {/* <div className="col-span-6 sm:col-span-3">
                  <label
